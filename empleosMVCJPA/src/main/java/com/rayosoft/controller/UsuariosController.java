...
public class UsuariosController {
	...
	public String activar(@PathVariable("id") int id, RedirectAttributes attributes) {
		serviceUsuarios.activar(id);
		attributes.addFlashAttribute("msg", "El usuario fue activado y tiene acceso al sistema");
		return "redirect:/usuarios/index";
	}
	@GetMapping("/lock/{id}")
	public String bloquear(@PathVariable("id") int id, RedirectAttributes attributes) {
		serviceUsuarios.bloquear(id);
		attributes.addFlashAttribute("msg", "El usuario fue bloqueado y no tiene acceso al sistema");
		return "redirect:/usuarios/index";
	}
	@GetMapping("/index")
